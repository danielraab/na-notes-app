-- This schema mirrors /docs/schema.md (ADR 0014), which was originally
-- extracted from backend-go's own migration. Keep it close to that
-- reference so migrating data between implementations stays tractable —
-- note any deliberate deviation in this folder's docs/decisions/.
