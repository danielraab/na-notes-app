-- Mirrors the reference schema in /docs/schema.md (ADR 0014), extracted
-- from backend-go's own schema. Update /docs/schema.md if a future
-- migration here changes the data model, not just SQL-dialect detail.
